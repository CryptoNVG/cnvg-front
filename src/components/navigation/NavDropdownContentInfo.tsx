...
interface NavDropdownContentInfoProps {
  group: Extract<NavGroup, { type: "info" }>;
  variant?: "desktop" | "mobile";
  onLinkClick?: () => void;
}

export function NavDropdownContentInfo({ 
  group, 
  variant = "desktop",
  onLinkClick 
}: NavDropdownContentInfoProps) {
...
export default NavDropdownContentInfo;
